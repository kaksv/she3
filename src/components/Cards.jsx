...
const Class = [
...

  {
    ...
    title: "Collaborate",
    explain:
      "Fostering partnerships and teamwork among women, Web3 experts, and organizations to share knowledge, resources, and opportunities",
  },
  {
    image: teach,
    title: "Innovate",
  ...
  return (
    <div className="card--container">
      <div className="empower">
        ...
        <p>
          Through this initiative, She3 aims to equip women with the skills and networks they need to take on leadership
          roles and drive meaningful change in the Web3 ecosystem.
        </p>
      </div>
