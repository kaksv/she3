...
const Classed = [
    ...
    {   image:teach,
        head:"Webinars",
        body:"Educating women about Web3 on our X, Telegram and Discord platforms"
    },
    {   image:teach,
                ...
                {Classed.map(({image,head,body}) => (
                    <div className = "list">
                      <div className="list--text">
                        <h2>{head}</h2>
                        {/* //.........regular expressions */}
                        {head=="Webinars" ? <p>`Educating women about Web3 on our <a target="_blank" href= "https://x.com/sheweb3" className = "Link">X</a> and <a href="#" className="Link">Discord</a> platforms`</p> : <p>{body}</p>}
                      </div>
